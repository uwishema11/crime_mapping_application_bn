...
crimeCategoryRouter.post('/create', (0, celebrate_1.celebrate)({ body: crimes_1.crimeCategoryValidation }), verifyAuth_1.default, crimeCategory_1.createCrimeCategoryController);
...
crimeCategoryRouter.patch('/edit/:id', verifyAuth_1.default, verifyAdmin_1.default, crimeCategory_1.updateCrimeCategoryController);
crimeCategoryRouter.delete('/delete/:id', verifyAuth_1.default, verifyAdmin_1.default, crimeCategory_1.deleteCrimeCategoryController);
